...
$from_email = "callme@kredit54.ru"; //From:
$subject = "Новая заявка";
$subject = "=?UTF-8?B?" . base64_encode($subject) . "?=";
$from_name = "Kredit54.ru"; //From:
